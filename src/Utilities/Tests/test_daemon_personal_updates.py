...
py -3.8 test_daemon_personal_updates.py

LINUX RUN COMMAND:
cd Repos/FCNF-Solver/
python3 test_daemon_personal_updates.py
"""
...
if __name__ == "__main__":
    ...
    # POPULATION OF ONLY 1 INDIVIDUAL
    ...
    # TEST OF PERSONAL MEDIAN DAEMON UPDATE
    ...
    gaVSga.geneticPopTwo.setDaemonHyperparams(isDaemonUsed=True, annealingConstant=4,
                                              daemonStrategy="personalMean", daemonStrength=0.10)
